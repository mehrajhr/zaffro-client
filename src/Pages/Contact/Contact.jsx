...
const Contact = () => {
  return (
    <div className="min-h-screen bg-base-100 text-neutral">
      ...
      {/* Hero Section */}
      <section className="bg-base-100 text-secondary py-20 px-5 md:px-20 text-center">
        <motion.h1
      ...
      <section className="py-20 px-5 md:px-20 flex flex-col md:flex-row justify-center items-start gap-16">
        ...
        <motion.div
          ...
          transition={{ duration: 1 }}
        >
          <h2 className="text-4xl text-black font-bold mb-6">Our Contact Information</h2>
          <div className="flex items-center gap-4 justify-center md:justify-start">
            <FaPhone className="text-accent" />
            <span className="text-black">+880 197 987 9095</span>
          </div>
          <div className="flex items-center gap-4 justify-center md:justify-start">
            <FaEnvelope className="text-accent" />
            <span className="text-black">zaffro2025@gmail.com</span>
          </div>
          <div className="flex items-center gap-4 justify-center md:justify-start">
            <FaMapMarkerAlt className="text-accent" />
            <span className="text-black">Debpahar, Chittagong, Bangladesh</span>
          </div>
      ...
      {/* CTA Section */}
      <section className="py-20 px-5 md:px-20 bg-green-500 text-white text-center rounded-tl-3xl rounded-tr-3xl">
        ...
        <Link
          to="/products"
          className="btn btn-secondary text-white font-bold px-10 py-4 hover:bg-primary hover:text-secondary transition"
        >
          Shop Now
        </Link>
      </section>
